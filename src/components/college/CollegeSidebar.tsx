...
export function CollegeSidebar({
  ...
  const sections = useMemo(() => COLLEGE_NAV_SECTIONS, []);
  ...
  return (
    <aside
      ...
      aria-label="College portal sidebar"
    >
      <div
        className={cn(
      ...
      >
        <Logo collapsed={collapsed} subtitle="College Portal" />
      </div>
                        ...
                        >
                          {({ isActive }) => (
                            <>
                              {isActive && (
                                <motion.span
                                  layoutId="college-sidebar-active-pill"
                              ...
                              {isActive && (
                                <motion.span
                                  layoutId="college-sidebar-active-dot"
